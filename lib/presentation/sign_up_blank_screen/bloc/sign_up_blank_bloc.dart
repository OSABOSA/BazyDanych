import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:test/presentation/sign_up_blank_screen/models/sign_up_blank_model.dart';part 'sign_up_blank_event.dart';part 'sign_up_blank_state.dart';/// A bloc that manages the state of a SignUpBlank according to the event that is dispatched to it.
