import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:test/presentation/refund_method_screen/models/refund_method_model.dart';part 'refund_method_event.dart';part 'refund_method_state.dart';/// A bloc that manages the state of a RefundMethod according to the event that is dispatched to it.
