import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:test/presentation/add_new_card_screen/models/add_new_card_model.dart';part 'add_new_card_event.dart';part 'add_new_card_state.dart';/// A bloc that manages the state of a AddNewCard according to the event that is dispatched to it.
